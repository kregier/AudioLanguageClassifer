...
\begin{center}
\begin{figure}
\includegraphics[width=4.25in]{GenderDistribution-All.png}
\end{figure}
\end{center}
\end{frame}
%------------------------------------------------
...
\begin{center}
\begin{figure}
\includegraphics[width=4.25in]{Top10LangCount.png}
...
\item 24\% accuracy with majority class distribution of 16\%.
\end{itemize}
\end{block}
...
Baseline accuracy of 15.7\% based on majority class distribution.
...
& Recall & 0.002840909 & 0.082386367 & 0.082386367\\ \hline
\multirow{3}{*}{F1 score} & Micro 
& 0.178977273 & 0.230113636  & 0.241477273\\
& Macro 
& 0.084855919 & 0.169606263 & 0.171586068 \\
& Weighted 
& 0.122333655 & 0.193686198 & 0.202591296 \\
\end{tabular}
...
\hline
Predictions & 3 & 80 & 9 & 8  & 6 & 61 & 27 & 27 & 32 & 26  & 73 &  352
